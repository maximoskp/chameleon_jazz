...
def print_gcts(m, output_file, write_mode='w'):
    ...
    if output_file == '':
        ...
        with open(output_file+'.txt', write_mode) as the_file:
            the_file.write('GCTs =================================================' + '\n')
...
# end print_gcts
def print_gct_families(m, output_file, write_mode='w'):
    # get necessary elements
    g = m.gct_group_info
    # if no output file is requested
    if output_file == '':
...
def print_cadences(m, output_file, write_mode='w'):
    with open(output_file+'.txt', write_mode) as the_file:
        the_file.write('')
    # types of cadences
...
def print_element(m, output_file, el, write_mode='w'):
    # if no output file is requested
    if output_file == '':
        print('Printing: ', el)
        if el == 'gcts':
...
def print_mode( m, output_file, include, write_mode='w' ):
