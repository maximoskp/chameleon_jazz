...
p_dense = np.delete(p, discarded_idx, axis=1)
print('p.shape: ', p_dense.shape)
...
n_dense = np.delete(n, discarded_idx, axis=1)
print('n.shape: ', n_dense.shape)
# %% plot sections
...
if render_MDS_chart_features_chords_distribution:
    X_embedded_MDS_chart_features_chords_distribution = MDS(n_components=2).fit_transform(chart_features_chords_distribution)
if render_MDS_chart_features_chords_transition_matrix_all:
    X_embedded_MDS_chart_features_chords_transition_matrix_all = MDS(n_components=2).fit_transform(chart_features_chords_transition_matrix_all)
    
if render_t_SNE_chart_features_chords_distribution:
    X_embedded_t_SNE_chart_features_chords_distribution = TSNE(n_components=2, init='pca', verbose=2, n_iter=3000).fit_transform(chart_features_chords_distribution)
if render_t_SNE_chart_features_chords_transition_matrix_all:
    X_embedded_t_SNE_chart_features_chords_transition_matrix_all = TSNE(n_components=2, init='pca', verbose=2, n_iter=3000).fit_transform(chart_features_chords_transition_matrix_all)
