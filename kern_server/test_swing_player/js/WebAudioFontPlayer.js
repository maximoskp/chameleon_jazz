...
var WebAudioFontPlayer = /** @class */ (function () {
    function WebAudioFontPlayer() {
        ...
        this.adjustZone = function (audioContext, zone) {
            if (zone.buffer) {
                //
                console.log('INSIDE zone buffer:', zone.buffer);
            }
            else {
                console.log('NOT INSIDE zone buffer - before:', zone.buffer);
                zone.delay = 0;
                if (zone.sample) {
                ...
                console.log('NOT INSIDE zone buffer - after:', zone.buffer);
            }
        };
    }
    ...
    WebAudioFontPlayer.prototype.findZone = function (audioContext, preset, pitch) {
        ...
        try {
            if (zone){
                ...
                console.log('NOT INSIDE zone:', zone);
            }
        }
        catch (ex) {
