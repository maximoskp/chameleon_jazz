class Metronome{
    ...
    constructor(audioManager){
        ...
        // audio clicks
        this.click = true;
        this.smallClick1 = new Audio('static/metronome_sounds/metroSmall.wav')
        this.smallClick1.crossOrigin="anonymous";
        this.smallClick2 = new Audio('static/metronome_sounds/metroSmall.wav')
        this.smallClick2.crossOrigin="anonymous";
        this.playSmall1 = true;
        this.bigClick = new Audio('static/metronome_sounds/metroBig.wav')
        ...
        this.timerWorker = new Worker("static/metronome_js/metronomeworker.js");
