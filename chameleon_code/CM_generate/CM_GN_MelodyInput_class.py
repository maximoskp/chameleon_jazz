...
class MelodyInput:
    ...
    def make_phrase_structure(self):
        ...
        phrase_idx += 1
        return phrases
    # end make_phrase_structure

    def print_info(self):
        print('MelodyInput info: ===============================')
        print('self.constraints:        ', self.constraints)
        self.constraints.show('t')
        print('self.harmonicRhythm:     ', self.harmonicRhythm)
        self.harmonicRhythm.show('t')
        print('self.importantNotes:     ', self.importantNotes)
        self.importantNotes.show('t')
        print('self.melodyNotes:        ', self.melodyNotes)
        self.melodyNotes.show('t')
        print('self.tonalities:         ', self.tonalities)
        for t in self.tonalities:
            t.print_info()
        print('self.groupings:          ', self.groupings)
        for g in self.groupings:
            g.print_info()
        print('self.tonality_offsets:   ', self.tonality_offsets)
        print('self.grouping_offsets:   ', self.grouping_offsets)
        print('phrases:')
